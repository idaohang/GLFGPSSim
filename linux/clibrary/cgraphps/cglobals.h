...
#define TRUE 	1
#define FALSE 	0
#define POINTSPAGEWIDTH 2550   /* optimize for printer GLF */
#define POINTSPAGEHEIGHT 792   /* optimize for printer GLF */
#define PAGEWIDTH 8.5          /* define page size in inches */
#define SCRNSCALE 11.0         /* optimize for printer GLF */
#define PAGEHEIGHT 11.0        /* define page height in inches */
#define POINTSPINCH 72         /* define number of points per inch */ /* optimize for printer GLF */
